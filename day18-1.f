...
C
      INTEGER TOTAL,GRID(0:XSIZE-1,0:YSIZE-1),X,Y,N
...
C
   ...
   20 FORMAT(A,I10,A)
C
      WRITE(*,10)"Advent of Code 2024 day 18, part 1"
      WRITE(*,10)" "
      OPEN(10,FILE="day18in.txt",STATUS="OLD",FORM="FORMATTED",
     +     ACCESS="SEQUENTIAL",ACTION="READ")
C
      CALL READBLOCKS(10,BLOCKS,1024)
      CLOSE(10)
C
...
C     Walk grid from start (1,1) to finish (71,71)
      ...
      WRITE(*,20)"Minimum distance is",TOTAL," steps"
      END
C
